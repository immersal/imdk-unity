...
namespace Immersal.Samples.ContentPlacement
{
    public class ContentStorageManager : MonoBehaviour
    {
        ...
        public void AddContent()
        {
            ...
            GameObject go = Instantiate(m_ContentPrefab, cameraTransform.position + cameraTransform.forward, Quaternion.identity, m_XRSpace.transform);
        }
        ...
        public void LoadContents()
        {
            ...
            try
            {
                ...
                {
                    GameObject go = Instantiate(m_ContentPrefab, m_XRSpace.transform);
